...
#if !defined(__linux__) && !defined(__BSD__) && !defined(TARGET_DOS) && !defined(TARGET_NANOSHELL) && (defined(ENABLE_OPENGL) || defined(ENABLE_OPENGL_LEGACY) || defined(ENABLE_SOFTRAST))
